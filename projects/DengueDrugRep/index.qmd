...
title: "DengueDrugRep"
description: |
  Drug repurposing for dengue using a biomedical knowledge graph and graph neural networks.
categories: 
  - 🔬Biomedicine
  - 🦠Microbiology
  - ⛃🕸️Knowledge graphs
...
date: "2023-10-16"
draft: false
image: https://raw.githubusercontent.com/sayalaruano/DengueDrugRep/HEAD/img/logo/denguedrugrep-logo.svg
---

[{{< fa brands github >}} Source code][source-code]{.btn target=_blank}
[{{< iconify simple-icons zenodo >}} GNN models][models-doi]{.btn target=_blank}
[{{< iconify simple-icons googlecolab >}} Run in Colab][run_colab]{.btn target=_blank} 
[{{< iconify ri slideshow-fill >}} Slides][presentation]{.btn target=_blank}

I developed this project for my capstone project of the **Scientific Programming** course from the [MSc in Systems Biology][sysbio] 
...
<p align="center">
  <img src="https://raw.githubusercontent.com/sayalaruano/DengueDrugRep/HEAD/img/logo/denguedrugrep-logo.svg" width="300" title="NTDs2RDF">
</p>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/sayalaruano/DengueDrugRep/HEAD/img/DengueDrugRep_workflow.svg" width="800" title="DengueDrugRep-graphabstract">
</p>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/sayalaruano/DengueDrugRep/HEAD/img/DRKG.png" width="800" title="DRKG-metagraph">
</p>

::: {.gray-italic .center-text}
**Figure 2.-** Metagraph of the DRKG. The number next to an edge indicates the number of relation-types for that entity-pair in the KG. Obtained from <a href="https://github.com/gnn4dr/DRKG">[2]</a>.
:::
...
<p align="center">
  <img src="https://raw.githubusercontent.com/sayalaruano/DengueDrugRep/HEAD/img/Compounds_DRKG_distribution.png" width="800" title="DRKG-compounds">
</p>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/sayalaruano/DengueDrugRep/HEAD/img/KGNN_pipeline.png" width="800" title="KGNN">
</p>

::: {.gray-italic .center-text}
**Figure 4.-** Strcuture of a Knowledge Graph Neural Network. Obtained from <a href="https://kge-tutorial-ecai2020.github.io/">[1]</a>.
:::
...
The trained models are available through Zenodo with the following DOI: [10.5281/zenodo.10010151][models-doi].
...
More details about the biological background of the project, the exploratory data analysis, feature engineering, models training, hyperparameter tuning, interpretation of the results, and ideas for further work are available in the [GitHub repository][source-code] of this project and its [presentation][presentation].

## Citation 

**Ayala-Ruano, S.** (2023). **DengueDrugRep: Drug repurposing for dengue using a biomedicine knowledge graph and graph neural networks** (Version 1.0.0) [Model]. *Zenodo*. doi: [doi.org/10.5281/zenodo.10010151][models-doi].
...
[source-code]: https://github.com/sayalaruano/DengueDrugRep
[presentation]: https://raw.githubusercontent.com/sayalaruano/DengueDrugRep/HEAD/DengueDrugRep_presentation.pdf
[run_colab]: https://colab.research.google.com/github/sayalaruano/DengueDrugRep/blob/main/Scripts/Training_KGNN_models_Pykeen.ipynb
...
[compounds_names_script]: https://github.com/sayalaruano/DengueDrugRep/Scripts/EDA_DRKG_compounds_names.py
[clin_trial_drugs]: https://github.com/sayalaruano/DengueDrugRep/Data/Clinical_trials/dengue_validated_drugs_clin.csv
[clinicaltrials]: https://clinicaltrials.gov/
[models-doi]: https://doi.org/10.5281/zenodo.10010151
...
[drkg_schema]: https://github.com/sayalaruano/DengueDrugRep/Data/DRKG/relation_glossary.tsv
[names_db_compounds]: https://github.com/sayalaruano/DengueDrugRep/Data/DRKG/Names_datasources_compounds_DRKG.csv